...
ActiveRecord::Schema[8.1].define(version: 2026_07_11_100004) do
  ...
  create_table "civic_profiles", force: :cascade do |t|
    ...
    t.string "faith_culture"
    t.string "faith_ethnicity"
    ...
    t.decimal "service_radius_mi", precision: 5, scale: 2
  ...
  create_table "forum_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.string "handle"
    t.string "perspective_type", default: "general", null: false
    t.string "social_url"
    t.datetime "updated_at", null: false
    t.integer "user_id"
    t.index ["bill_num"], name: "index_forum_comments_on_bill_num"
    t.index ["perspective_type"], name: "index_forum_comments_on_perspective_type"
  ...
  create_table "sacred_fire_entries", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "wiki_title"
    t.string "wiki_title_incident"
    t.integer "year_of_incident"
    t.index ["country"], name: "index_sacred_fire_entries_on_country"
    t.index ["latitude", "longitude"], name: "index_sacred_fire_entries_on_latitude_and_longitude"
