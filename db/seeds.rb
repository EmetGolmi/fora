...
# ── On This Day — Philadelphia ────────────────────────────────────────────────
load Rails.root.join("db/seeds/on_this_day_philadelphia.rb").to_s

# Purge stale records not present in the current curated file
...
load Rails.root.join("db/seeds/formation_pa_home_inspector.rb")
load Rails.root.join("db/seeds/market.rb")
